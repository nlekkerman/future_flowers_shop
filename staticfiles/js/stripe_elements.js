...
form.addEventListener('submit', function (ev) {
    ...
    $.post(url, postData).done(function () {
            stripe.confirmCardPayment(clientSecret, {
                    payment_method: {
                        card: card,
                        billing_details: { // Make sure this is part of payment_method
        ...
        .fail(function () {
            console.error('Post request to cache checkout data failed');
            alert('Post request failed. Page will reload.');
            location.reload();
        });
