...
async function loadReviews() {
    ...
    fetch('/reviews/api/reviews/')
        ...
        .then(data => {
            ...
            closeButton.innerHTML = `<i class="fas fa-times"></i>`; // Using FontAwesome icon
            closeButton.style.position = 'absolute';
            closeButton.style.top = '10px'; // Adjust to desired position
            closeButton.style.right = '10px'; // Adjust to desired position
            ...
            writeReviewButton.innerHTML = `<i> Write </i>  `;
            ...
            rowElement.classList.add('row', 'custom-review-row');
            ...
            data.reviews.forEach(review => {
                ...
                reviewElement.classList.add('col-12', 'col-md-6', 'col-lg-4', 'col-xl-2', 'mb-4', 'd-flex');
                ...
                <div class="review-card w-100 ml-2 p-1" style="border-right: 2px solid #333; background-color: rgba(0, 0, 0, 0.8);">
                    <div class="card-body">
                        ...
                        <p class="card-text"><small>Posted on: ${review.created_at}</small></p>

                        <h3>Comments:</h3>
                        <ul id="comment-list-${review.id}"></ul>
                    </div>
                </div>
                `;
                ...
                review.comments.forEach(comment => {
                    ...
                    commentElement.textContent = `${comment.user}: ${comment.text} (${comment.created_at})`;
